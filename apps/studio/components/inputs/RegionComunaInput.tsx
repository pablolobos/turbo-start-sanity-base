...
import { Stack, Card, Text, Select, Box } from '@sanity/ui'
import { FormField, ObjectInputProps } from 'sanity'
...
export const RegionComunaInput = (props: ObjectInputProps) => {
    const { onChange, value = {} as DireccionValue, renderDefault } = props
    ...
    return (
        <Stack space={4}>
            <Card padding={4} radius={2} shadow={1}>
                <Stack space={4}>
                    <Box>
                        <Text weight="semibold">Región</Text>
                        <Select
                    ...
                    <Box>
                        <Text weight="semibold">Comuna</Text>
                        <Select
