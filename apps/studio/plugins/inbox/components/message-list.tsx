...
interface TabPanelsProps extends MessageListProps {
    currentTab: string;
}
...
function MessageTabList({ currentTab, setCurrentTab }: TabListProps) {
    return (
        <TabList space={3}>
            <Tab
...
function AllMessages({ messages, deleteMessage, starMessage, readMessage }: MessageListProps) {
    return (
        <Stack
            space={3}
            padding={[3]}
...
function StarredMessages({ messages, deleteMessage, starMessage, readMessage }: MessageListProps) {
...
function UnreadMessages({ messages, deleteMessage, starMessage, readMessage }: MessageListProps) {
