...
// Query: *[_type == "settings"][0]{    _id,    _type,    siteTitle,    siteDescription,    socialLinks{      linkedin,      facebook,      twitter,      instagram,      youtube    },      cotizadorFormTitle,  cotizadorFormDescription,  "cotizadorForm": coalesce(cotizadorForm->{    _id,    _type,    title,    description,    "slug": slug.current,      fields[]{    label,    name,    type,    required,    options,    placeholder  },  emailRecipients,  submitButtonText,  successMessage,  errorMessage  }, null)  }
...
// Query: *[  _type == "settings"][0]{  _id,    cotizadorFormTitle,  cotizadorFormDescription,  "cotizadorForm": coalesce(cotizadorForm->{    _id,    _type,    title,    description,    "slug": slug.current,      fields[]{    label,    name,    type,    required,    options,    placeholder  },  emailRecipients,  submitButtonText,  successMessage,  errorMessage  }, null)}
